...
namespace engine {
	...
	public:
		...
		D3D12WrapperDevice& SetQueues(std::vector<rhi::Queue> queues) { this->queues = queues; return *this; }

		ComPtr<ID3D12Device> GetDevice() const { return device; }
		std::vector<rhi::Queue> GetQueues() const { return queues; }
	...
	public:
		...
		D3D12WrapperCommandPool& SetCommandBuffers(std::vector<rhi::CommandBuffer> commandBuffers) { this->commandBuffers = commandBuffers; return *this; }

		D3D12_COMMAND_LIST_TYPE GetQueueType() const { return queueType; }
		ComPtr<ID3D12CommandAllocator> GetCommandAllocator() const { return commandAllocator; }
		std::vector<rhi::CommandBuffer> GetCommandBuffers() const { return commandBuffers; }
	...
	class D3D12WrapperBufferView final : public rhi::BufferView_T {
	public:
	...
	class D3D12WrapperImageView final : public rhi::ImageView_T {
	public:
